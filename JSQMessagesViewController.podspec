Pod::Spec.new do |s|
	...
	s.source				= { :git => 'https://github.com/lets-talk/JSQMessagesViewController.git', :tag => s.version }
	s.platform				= :ios, '7.0'	
	s.source_files			= 'JSQMessagesViewController/**/*.{h,m}'
	s.resources 			= ['JSQMessagesViewController/Assets/JSQMessagesAssets.bundle', 'JSQMessagesViewController/**/*.{xib}']'JSQMessagesViewController/**/*.{xib}',
